...
namespace SphereSharp.Cli
{
    class Program
    {
        ...
        {
            CommandLine.Parser.Default.ParseArguments<RoundtripOptions, TranspileOptions, TranspileSaveOptions, TranspileShardOptions, CreateShardSettingsOptions>(args)
